...
const CountryCard = ({ country, onClose }) => {
  ...
  return (
    <section className="h-fit bg-veryLightGray  p-5 pb-10 text-left text-veryDarkBlueLight xl:-mx-40 xl:px-40 dark:bg-veryDarkBlueDark">
      <button
        className="my-2 rounded-sm px-6 py-1 xl:mb-10 xl:mt-6 2xl:px-10 2xl:py-3 bg-white dark:bg-darkBlue dark:text-white"
        onClick={onClose}
      >
      ...
      <div className="space-y-6 text-veryDarkBlueLight xl:flex xl:flex-auto xl:space-x-20 dark:bg-veryDarkBlueDark dark:text-white ">
        <div className="xl:h-[275px] xl:w-[350px] xl:flex-1 xl:self-center 2xl:h-[500px] 2xl:w-[850px] 2xl:flex-none">
          <img
            src={country.flag}
            alt={country.name}
            className="max-xl:my-5 md:mx-auto md:size-5/6 xl:size-full"
          />
        </div>
        <div className="h-fit xl:flex-1 [&_strong]:font-medium">
          ...
          <div className="xl:flex xl:space-x-10 2xl:space-x-40 [&>div]:space-y-2 [&>div]:max-xl:my-8 [&>div]:2xl:space-y-4">
            <div>
              <p>
          ...
          {borderCountries.length > 1 && (
            <div className="xl:mt-8">
              <div className="flex flex-row flex-wrap md:space-x-4">
                <h2 className="my-2 py-2 font-medium">Border Countries: </h2>
